...
export default function MissionIntro({ intro, skipMissionIntro, onSkipMissionIntro, onStart }) {
  return (
    <main className="v2-mission-arena" aria-label="Mission introduction">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        <section className="min-w-0">
          <h3 className="flex items-center gap-2 text-gold"><MapPin size={18} /> Destination</h3>
          <p className="mt-2 text-sm text-muted">{intro.location}</p>
        </section>
        <section className="min-w-0">
          <h3 className="flex items-center gap-2 text-gold"><Target size={18} /> Mission types</h3>
